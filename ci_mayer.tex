...
rasterized visualizations of geospatial data which is used to aid
qualitative evaluation of scientific data emanating from multiple
sources.
...
a cross-platform \wms{} service which can leverage the suite of tools
