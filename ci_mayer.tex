...
\author{Brandon A. Mayer$^{1,2}$, Brian McKenna, Dave Foster, Kelly Knee\thanks{Brown University$^{1}$, RPS ASA, South Kingston RI$^{2}$},\thanks{\{BMayer,BMcKenna,DFoster,KKnee\}@asascience.com}}
